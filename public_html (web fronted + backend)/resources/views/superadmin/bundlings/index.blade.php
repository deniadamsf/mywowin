...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-white to-purple-50 p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('superadmin.bundlings.index') }}" class="text-sm font-medium text-white bg-purple-700 px-4 py-2 rounded-lg hover:bg-[#135e24] transition flex items-center">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center">
                <i class="fas fa-table text-purple-700 mr-2"></i> Data Bundling
            </h2>
            
            <!-- Search Box -->
            <div class="relative">
                <form action="{{ route('superadmin.bundlings.index') }}" method="GET">
        ...
        <div class="flex justify-between mb-4">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('superadmin.bundlings.create') }}" class="bg-purple-700 text-white px-4 py-2 rounded-lg text-sm hover:bg-[#135e24] transition flex items-center">
                    <i class="fas fa-plus-circle mr-2"></i> Tambah Bundling
                </a>
                <!--<a href="#" class="bg-green-700 text-white px-4 py-2 rounded-lg text-sm hover:bg-gray-800 transition flex items-center">-->
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-gray-50 text-gray-700 border-b">
                        ...
                        <th class="px-6 py-3 text-left">
                            <div class="flex items-center">
                                <i class="fas fa-box-open mr-2 text-purple-700"></i>
                                Nama Bundling
                            </div>
                        </th>
                        <th class="px-6 py-3 text-left">
                        ...
                        <th class="px-6 py-3 text-left">
                            <div class="flex items-center">
                                <i class="fas fa-calendar-times mr-2 text-purple-700"></i>
                                Waktu Selesai
                            </div>
                        </th>
                        ...
                        <tr class="hover:bg-gray-50 border-b border-gray-100 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center gap-2">
                                                ...
                                                <div class="absolute right-0 top-0 bg-white w-full max-w-md h-full shadow-2xl p-6 overflow-y-auto animate__animated animate__fadeInRight animate__faster">
                                                    ...
                                                    <div class="space-y-4">
                                                        ...
                                                        <div class="bg-gray-50 p-4 rounded-lg">
                                                            ...
                                                            @if(!empty($bundling->youtube_link))
                                                                <div class="aspect-w-16 aspect-h-9">
                                                                    <iframe 
                                                                        class="w-full h-64 rounded-lg"
                                                                        src="{{ $bundling->youtube_link }}" 
                                                                        frameborder="0" 
                                                            ...
                                                            @else
                                                                <p class="text-gray-500 italic text-sm">Belum ada video promo.</p>
                                                            @endif
                                                        </div>
                                    ...
                                    <div x-data="{ showEditModal: false }" class="relative">
                                       ...
                                       <div x-show="showEditModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                            <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 animate__animated animate__fadeInDown animate__faster overflow-y-auto max-h-screen">
                                                ...
                                                <form method="POST" action="{{ route('superadmin.bundlings.update', $bundling->id_bundling) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="grid grid-cols-2 gap-4">
                                                        <div>
                                                            ...
                                                            <div class="relative">
                                                                ...
                                                                <input type="text" name="nama_bundling" value="{{ $bundling->nama_bundling }}" class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-purple-700 focus:border-purple-700">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="relative">
                                                                ...
                                                                <input type="date" name="waktu_diskon_mulai" value="{{ $bundling->waktu_diskon_mulai }}" class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-purple-700 focus:border-purple-700">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="relative">
                                                                ...
                                                                <input type="date" name="waktu_diskon_selesai" value="{{ $bundling->waktu_diskon_selesai }}" class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-purple-700 focus:border-purple-700">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="relative">
                                                                ...
                                                                <input type="number" name="price" value="{{ $bundling->price }}" class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-purple-700 focus:border-purple-700">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="relative">
                                                                ...
                                                                <input type="number" name="price_before" value="{{ $bundling->price_before }}" class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-purple-700 focus:border-purple-700">
                                                            </div>
                                                        </div>
                                                        <!-- Edit Input YouTube Link -->
                                                        <div class="mt-4">
                                                            <label for="youtube_link" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                                                                <i class="fab fa-youtube text-red-600 mr-2"></i>
                                                                Link Video YouTube (untuk promo)
                                                            </label>
                                                            <input 
                                                                type="url" 
                                                                name="youtube_link" 
                                                                ...
                                                                placeholder="Masukkan link YouTube, contoh: https://youtu.be/xxxxxxx" 
                                                                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-purple-700 focus:border-purple-700 text-sm"
                                                            >
                                                             <p class="text-xs text-gray-500 mt-1">Kosongkan jika tidak ingin mengubah link.</p>
                                                            @error('youtube_link')
                                                        ...
                                                        {{-- <div>
                                                            ...
                                                            <div class="flex items-center mb-2">
                                                                ...
                                                                <div class="relative flex-1">
                                                                    ...
                                                                    <input type="file" name="barang_bundling" class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-purple-700 focus:border-purple-700 text-sm">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="relative bg-gray-50 border border-gray-200 rounded-lg p-3">
                                                            ...
                                                            <div class="relative">
                                                                ...
                                                                <input 
                                                                    type="file" 
                                                                    name="barang_bundling" 
                                                                    class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-purple-700 focus:border-purple-700 text-sm bg-white"
                                                                >
                                                            </div>
                                                            ...
                                                            @if (!empty($bundling->barang_bundling))
                                                                <div class="mt-3">
                                                                    ...
                                                                    <div class="w-28 h-28 rounded-lg overflow-hidden border hover:shadow-md transition">
                                                                        <img src="{{ asset('storage/' . $bundling->barang_bundling) }}" 
                                                                            class="w-full h-full object-cover" 
                                                                            alt="{{ $bundling->nama_bundling }}">
                                                                    </div>
                                                  ...
                                                  <div>
                                                    ...
                                                    {{-- CKEditor Container (Tanpa icon absolute) --}}
                                                    <div class="border border-gray-300 rounded-md overflow-hidden">
                                                        <textarea 
                                                            name="snk" 
                                                            id="snk_{{ $bundling->id_bundling }}" 
                                                            class="w-full"
                                                        >{{ $bundling->snk }}</textarea>
                                                    </div>
                                                    <p class="text-xs text-gray-500 mt-1">Gunakan bold atau bullet list jika diperlukan.</p>
                                                </div>
                                                <style>
                                                   .ck.ck-editor__editable_inline {
                                                    ...
                                                    <div class="col-span-2">
                                                        ...
                                                        <div class="relative">
                                                            ...
                                                            <select name="products[]" id="products_{{ $bundling->id_bundling }}" class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-purple-700 focus:border-purple-700 select2" multiple required>
                                    ...
                                    <!-- Tombol Hapus -->
                                    <form onsubmit="return confirm('Apakah Anda yakin ingin menghapus bundling ini?');" action="{{ route('superadmin.bundlings.destroy', $bundling->id_bundling) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
        ...
        <!-- Pagination -->
        <div class="mt-6">
            {{ $bundlings->links('vendor.pagination.custom') }}
        </div>
    </div>
</div>
<!-- Toast Notification -->
