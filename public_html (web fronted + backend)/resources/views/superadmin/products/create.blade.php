...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-white to-purple-50 p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('superadmin.products.index') }}" class="text-sm font-medium text-purple-700 border border-purple-700 px-4 py-2 rounded-lg hover:bg-purple-700/10 transition flex items-center">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
        <div class="flex items-center justify-center mb-6">
            <div class="bg-purple-700/10 p-4 rounded-full">
                <i class="fas fa-box-open text-2xl text-purple-700"></i>
            </div>
        </div>
        ...
        <form action="{{ route('superadmin.products.store') }}" method="POST" enctype="multipart/form-data" class="mx-auto max-w-4xl" id="productForm">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl">
                        <label for="no_bpom" class="block text-gray-700 font-medium mb-2 flex items-center">
                            <i class="fas fa-certificate text-purple-700 mr-2"></i>
                            Nomor BPOM
                        </label>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl">
                        <label for="isi_ml" class="block text-gray-700 font-medium mb-2 flex items-center">
                            <i class="fas fa-flask text-purple-700 mr-2"></i>
                            Isi Permili
                        </label>
                        <div class="relative">
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl">
                        <label for="isi_karton" class="block text-gray-700 font-medium mb-2 flex items-center">
                            <i class="fas fa-box text-purple-700 mr-2"></i>
                            Isi tiap karton
                        </label>
            ...
            <div class="mt-6 bg-gray-50 p-4 rounded-xl">
                <label for="rekom_guna" class="block text-gray-700 font-medium mb-2 flex items-center">
                    <i class="fas fa-info-circle text-purple-700 mr-2"></i>
            ...
            <div class="mt-6 bg-gray-50 p-4 rounded-xl">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-purple-700 transition-colors cursor-pointer bg-white mb-3">
                    ...
                    <label for="singleImageInput" class="cursor-pointer block">
                        <div class="mx-auto w-16 h-16 bg-purple-700/10 rounded-full flex items-center justify-center mb-3">
                            <i class="fas fa-image text-2xl text-purple-700"></i>
                        </div>
                ...
                <button type="button" id="addMoreImages" class="bg-purple-700/10 hover:bg-purple-700/20 text-purple-700 font-medium py-2 px-4 rounded-lg transition-colors focus:outline-none flex items-center justify-center w-full mb-3">
