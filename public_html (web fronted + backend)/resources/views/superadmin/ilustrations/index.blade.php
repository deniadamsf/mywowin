...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-white to-purple-50 p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <nav class="flex text-sm mb-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li class="flex items-center text-gray-500">
                    ...
                    <a href="{{ route('superadmin.ilustrations.index') }}" class="hover:text-purple-700 transition-colors duration-200">Kelola Tampilan</a>
                </li>
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('superadmin.ilustrations.index') }}" class="text-sm font-medium text-white bg-purple-700 px-4 py-2 rounded-lg hover:bg-[#135e24] transition flex items-center">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center">
                <i class="fas fa-table text-purple-700 mr-2"></i> Master Tampilan Login
            </h2>
            
            <a href="{{ route('superadmin.ilustrations.create') }}" class="bg-purple-700 hover:bg-[#135e24] text-white font-semibold py-2 px-4 rounded-lg transition flex items-center">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    <div x-data="{ showEditModal: false }" class="relative">
                                        ...
                                        <div x-show="showEditModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center">
                                            ...
                                            <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 z-10 animate__animated animate__fadeInDown animate__faster">
                                                ...
                                                <form method="POST" action="{{ route('superadmin.ilustrations.update', $ilustration->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                                ...
                                                                <div class="w-full">
                                                                    <div class="flex items-center justify-center bg-grey-lighter">
                                                                        <label class="w-full flex flex-col items-center px-4 py-2 bg-white text-blue rounded-lg shadow-lg tracking-wide border border-blue cursor-pointer hover:bg-blue-500 hover:text-white transition">
                                                                            <i class="fas fa-cloud-upload-alt text-purple-700"></i>
                                    ...
                                    <form onsubmit="return confirm('Apakah Anda yakin ingin menghapus gambar ini?');"
                                        action="{{ route('superadmin.ilustrations.destroy', $ilustration->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
