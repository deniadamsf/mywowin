...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-white to-purple-50 p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <nav class="flex text-sm mb-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li class="flex items-center text-gray-500">
                    ...
                    <a href="{{ route('superadmin.ilustrations.index') }}" class="hover:text-purple-700 transition-colors duration-200">Tampilan Login</a>
                </li>
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('superadmin.ilustrations.index') }}" class="text-sm font-medium text-purple-700 border border-purple-700 px-4 py-2 rounded-lg hover:bg-purple-700/10 transition flex items-center">
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 mt-6">
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <!-- Form -->
        <form action="{{ route('superadmin.ilustrations.store') }}" method="POST" enctype="multipart/form-data" class="max-w-xl mx-auto">
            @csrf
