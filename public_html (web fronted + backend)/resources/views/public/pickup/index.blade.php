...
<br>
<h1 class="text-2xl font-semibold text-black text-center">Pengambilan Langsung</h1>
<!-- Accordion FAQ MyWowin -->
<div class="max-w-3xl mx-auto mt-6">
    <div class="bg-white shadow-lg rounded-xl divide-y divide-gray-200">
        @php
            $faqs = [
                 // Pertanyaan tentang pengambilan langsung di PT. Wowin
    ['q' => '🏢 Apakah saya bisa mengambil pesanan saya langsung di PT. Wowin?', 'a' => 'Ya, kamu bisa mengambil pesanan secara langsung di PT. Wowin Purnomo Putera setelah mendapat konfirmasi bahwa pesananmu siap diambil.'],

['q' => '🏢 Bagaimana cara melakukan pengambilan langsung di PT. Wowin?', 'a' => 'Untuk mengambil pesanan langsung, pastikan kamu menerima konfirmasi email atau SMS yang berisi informasi pengambilan dan waktu yang telah ditentukan.'],

['q' => '🏢 Apa persyaratan untuk mengambil pesanan langsung?', 'a' => 'Pastikan kamu membawa bukti pembayaran atau nomor pesanan yang valid saat datang untuk pengambilan. Informasi lebih lanjut akan diberikan setelah pesanan dikonfirmasi.'],

['q' => '🏢 Apakah ada biaya tambahan untuk pengambilan langsung di PT. Wowin?', 'a' => 'Tidak ada biaya tambahan untuk pengambilan langsung di PT. Wowin. Namun, pastikan untuk mengambil pesanan sesuai waktu yang telah ditentukan untuk menghindari keterlambatan atau masalah lainnya.'],
            ];
        @endphp
