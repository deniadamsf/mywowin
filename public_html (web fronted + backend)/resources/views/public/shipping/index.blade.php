...
<br>
<h1 class="text-2xl font-semibold text-black text-center">Pengiriman</h1>
    ...
    <div class="bg-white shadow-lg rounded-xl divide-y divide-gray-200">
        @php
            $faqs = [
                ...
                // Pengiriman
                ['q' => '🚚 Apakah pengiriman dilakukan oleh pihak ketiga?', 'a' => 'Tidak. Semua pesanan dikirim langsung oleh tim logistik resmi dari PT Wowin Purnomo Putera untuk menjamin kualitas dan kecepatan pengiriman.'],
                ['q' => '🚚 Berapa lama waktu pengiriman setelah saya melakukan pembayaran?', 'a' => 'Proses pengiriman dimulai maksimal 1x24 jam setelah pembayaran dikonfirmasi. Waktu sampai tergantung lokasi, namun rata-rata 2–5 hari kerja.'],
                ['q' => '🚚 Apakah saya bisa melacak status pengiriman?', 'a' => 'Ya, kamu akan mendapatkan notifikasi dan kode pelacakan (tracking) setelah barang dikirim. Kamu bisa cek statusnya langsung melalui aplikasi atau website MyWowin.'],
                ['q' => '🚚 Bagaimana jika ada kendala dalam pengiriman?', 'a' => 'Jika terjadi keterlambatan atau masalah dalam pengiriman, kamu bisa langsung menghubungi tim CS MyWowin melalui kontak yang tersedia. Kami akan bantu selesaikan dengan cepat.'],
            ];
        @endphp
