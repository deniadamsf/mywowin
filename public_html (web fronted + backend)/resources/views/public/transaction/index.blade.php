...
<br>
<h1 class="text-2xl font-semibold text-black text-center">Pembayaran</h1>
<!-- Accordion FAQ MyWowin -->
<div class="max-w-3xl mx-auto mt-6">
    <div class="bg-white shadow-lg rounded-xl divide-y divide-gray-200">
        @php
            $faqs = [
                ['q' => '💳 Apa saja metode pembayaran yang tersedia di MyWowin?', 'a' => 'MyWowin menyediakan tiga metode pembayaran: melalui WhatsApp (WA), Cash On Delivery (COD), dan Transfer Bank. Pilih yang paling sesuai dengan kebutuhanmu.'],

    ['q' => '💳 Bagaimana cara membayar melalui WhatsApp (WA)?', 'a' => 'Untuk membayar melalui WhatsApp, kamu akan menerima instruksi pembayaran langsung melalui chat. Ikuti langkah-langkahnya dan lakukan pembayaran sesuai instruksi yang diberikan.'],

    ['q' => '💳 Apakah saya bisa memilih pembayaran COD (Cash On Delivery)?', 'a' => 'Ya, kamu bisa memilih metode COD saat checkout. Pembayaran dilakukan langsung saat produk tiba di alamat yang kamu tentukan. Pastikan alamat pengiriman sudah benar untuk menghindari kesalahan pengiriman.'],

    ['q' => '💳 Bagaimana cara melakukan pembayaran melalui transfer bank?', 'a' => 'Untuk pembayaran via transfer bank, setelah melakukan pemesanan, kamu akan diberikan nomor rekening tujuan untuk melakukan transfer. Setelah pembayaran selesai, konfirmasikan pembayaran melalui aplikasi atau website untuk memproses pesananmu.'],
            ];
        @endphp
