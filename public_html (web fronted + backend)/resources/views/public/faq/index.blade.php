...
<br>
<h1 class="text-2xl font-semibold text-black text-center">Aplikasi</h1>
<!-- Accordion FAQ MyWowin -->
<div class="max-w-3xl mx-auto mt-6">
    <div class="bg-white shadow-lg rounded-xl divide-y divide-gray-200">
        @php
            $faqs = [
                ['q' => 'Apa itu MyWowin?', 'a' => 'MyWowin adalah aplikasi resmi dari WOWIN yang memberikan kemudahan berbelanja dan mendapatkan poin reward.'],
                ['q' => 'Bagaimana cara install MyWowin?', 'a' => 'Kamu bisa mengunduh MyWowin melalui Play Store untuk Android atau App Store untuk iOS.'],
                ['q' => 'Kenapa saya tidak bisa install MyWowin di perangkat saya?', 'a' => 'Pastikan perangkatmu kompatibel dengan aplikasi MyWowin dan memiliki versi OS terbaru.'],
            ];
        @endphp
