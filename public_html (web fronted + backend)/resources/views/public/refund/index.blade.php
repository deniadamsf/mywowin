...
<br>
<h1 class="text-2xl font-semibold text-black text-center">Refund</h1>
<!-- Accordion FAQ MyWowin -->
<div class="max-w-3xl mx-auto mt-6">
    <div class="bg-white shadow-lg rounded-xl divide-y divide-gray-200">
        @php
            $faqs = [
                ['q' => '💔 Bagaimana cara mengajukan refund barang yang rusak jika membeli melalui TikTok Shop?', 'a' => 'Jika barang yang kamu terima rusak, kamu dapat mengajukan refund dengan syarat menyertakan bukti video yang jelas menunjukkan kerusakan barang. Pastikan untuk menghubungi customer service TikTok Shop segera setelah menerima barang rusak.'],
    
    ['q' => '💔 Apakah saya bisa mengajukan refund jika tidak memiliki bukti video barang rusak?', 'a' => 'Sayangnya, untuk pengajuan refund barang rusak melalui TikTok Shop, kamu wajib melampirkan bukti video yang menunjukkan kondisi barang saat diterima. Tanpa bukti video, pengajuan refund tidak dapat diproses.'],
    
    ['q' => '💔 Berapa lama saya bisa mengajukan refund untuk barang yang rusak di TikTok Shop?', 'a' => 'Kamu dapat mengajukan refund barang rusak dalam waktu tertentu setelah barang diterima. Pastikan untuk segera menghubungi customer service TikTok Shop dan melampirkan bukti video dalam jangka waktu yang ditentukan untuk memastikan proses refund berjalan lancar.']
            ];
        @endphp
