...
<head>
    ...
    <style>
        ...
        .gradient-bg {
            background: linear-gradient(135deg, #16782d, #00b140); /* Fresh gradient */
        }
    ...
    <nav class="bg-white nav-shadow p-4 flex justify-between items-center fixed top-0 left-0 w-full z-50">
        <div class="flex items-center">
            ...
            <div class="hidden lg:flex items-center space-x-3 ml-4">
                <!-- Logo -->
                <div class="w-12 h-8 rounded-md flex items-center justify-center overflow-hidden">
                    <img src="{{ asset('images/lg-h.png') }}" alt="Logo" class="object-contain w-full h-full" />
                </div>
                <div class="flex flex-col">
                    <span class="text-xl logo-text leading-none text-[#16782d]">MyWowin</span>
            ...
            <div class="hidden md:flex items-center">
                ...
                <div class="relative">
                    ...
                    <div class="user-menu animate-dropdown absolute right-0 mt-2 w-56 bg-white divide-y divide-gray-100 rounded-lg shadow-xl hidden transform scale-95 opacity-0" id="user-dropdown">
                        ...
                        <ul class="py-1">
                            <li><a href="{{ route('admin.dashboard') }}" class="menu-item flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                            ...
                            <li><a href="{{ route('admin.settings.index') }}" class="menu-item flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 mr-2 text-gray-500">
