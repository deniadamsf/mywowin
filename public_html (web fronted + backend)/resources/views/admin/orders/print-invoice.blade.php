    ...
    <div class="invoice-container">
       <!-- Header dengan Logo dan Nama Toko -->
        ...
        @if($branchSetting && $branchSetting->logo)
            <img src="{{ asset('storage/' . $branchSetting->logo) }}" alt="Logo Toko" class="logo">
        @else
            <img src="{{ asset('images/wwn-cr.png') }}" alt="Logo Default" class="logo">
        @endif
    </div>
    <div class="company-info">
        <h1 class="company-name">{{ $branchSetting->nama_pt ?? 'PT. WOWIN PURNOMO PUTERA' }}</h1>
        <div class="company-tagline">Sahabat Hidangan Anda</div>
        <div class="company-details">
            @if($branchSetting)
                <p>{{ $branchSetting->alamat }}</p>
                <p>Telepon: {{ $branchSetting->no_telp }} </p>
            @else
        ...
        <div class="thanks-message">
            Terima kasih atas kepercayaan Anda kepada {{ $branchSetting->nama_pt ?? 'PT. Wowin Purnomo Putera' }}
        </div>
        ...
        <div class="footer">
            ...
            <p>{{ $branchSetting->nama_pt ?? 'PT. Wowin Purnomo Putera' }} &copy; {{ date('Y') }} | Hak Cipta Dilindungi</p>
        </div>
    </div>
