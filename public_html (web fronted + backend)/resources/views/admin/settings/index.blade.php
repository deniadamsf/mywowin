...
@section('title', 'WOWINFood - Admin Profile')
...
<div class="bg-gray-50 min-h-screen pb-12">
    <!-- Header -->
    <div class="bg-gradient-to-r from-green-700 to-green-600 shadow-md">
        <div class="container mx-auto px-4 py-6">
            <!-- Breadcrumb -->
            <nav class="flex mb-4 text-sm" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    <li class="inline-flex items-center">
                        <a href="{{ route('admin.dashboard') }}" class="text-green-100 hover:text-white flex items-center transition-colors">
                            <i class="fas fa-home mr-2"></i>
                            Dashboard
                        </a>
                    </li>
                    <li class="flex items-center text-green-50">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0">
                        <img src="{{ auth()->user()->foto_profile ? asset('storage/'.auth()->user()->foto_profile) : asset('images/default-avatar.png') }}" 
                            alt="Profile Avatar" 
                            class="w-16 h-16 rounded-full border-2 border-white object-cover shadow-lg">
                    </div>
                    <div>
                        <h1 class="text-2xl font-bold text-white">{{ auth()->user()->nama_lengkap }}</h1>
                ...
                <div class="mt-4 md:mt-0 flex space-x-3">
                    <a href="{{ route('admin.dashboard') }}" class="text-sm font-medium text-white hover:text-green-100 border border-green-200 px-4 py-2 rounded-lg hover:bg-white/10 transition flex items-center">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="profile-card bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6 border-b border-gray-200 bg-gray-50">
                <div class="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
                    <div class="relative">
                        ...
                        <label for="avatar-upload" class="absolute bottom-0 right-0 bg-green-600 rounded-full p-2 border-2 border-white cursor-pointer shadow avatar-upload transition-colors duration-300">
            ...
            <!-- Form Section -->
            <form action="{{ route('admin.settings.update', auth()->user()->id) }}" method="POST" enctype="multipart/form-data" id="profile-form">
                @csrf
                @method('PUT')
                ...
                <div class="p-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="nama_lengkap" name="nama_lengkap" 
                                        ...
                                        class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                </div>
                                @error('nama_lengkap')
                    ...
                    <div class="flex justify-end">
                        <button type="submit" id="form-submit" 
                            class="inline-flex items-center px-6 py-2.5 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-300">
...
<script>
    ...
    fileInput.addEventListener('change', function() {
        if (this.files && this.files[0]) {
            ...
            // PREVIEW SAJA (Tidak ada submit di sini)
    ...
    // 3. Logika saat KLIK TOMBOL SIMPAN (Baru Muncul Loading)
    profileForm.addEventListener('submit', function() {
        loadingScreen.style.display = 'flex';
        // Form akan terkirim secara alami ke Controller
    });
</script>
@endsection