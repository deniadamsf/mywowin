...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-white to-green-50 p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <nav class="flex text-sm mb-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                <li class="inline-flex items-center">
                    <a href="{{ route('admin.dashboard') }}" class="text-gray-700 hover:text-[#16782d] flex items-center">
                ...
                <li class="flex items-center text-gray-500">
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="hover:text-[#16782d]">Kelola Kategori</a>
                </li>
        ...
        <div class="flex gap-3 mt-4">
            <a href="{{ route('admin.dashboard') }}" class="text-sm font-medium text-[#16782d] border border-[#16782d] px-4 py-2 rounded-lg hover:bg-[#16782d]/10 flex items-center">
                <i class="fas fa-tachometer-alt mr-2"></i> Dashboard
            </a>
            <a href="{{ route('admin.categories.index') }}" class="text-sm font-medium text-[#16782d] border border-[#16782d] px-4 py-2 rounded-lg hover:bg-[#16782d]/10 flex items-center">
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 mt-6">
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <div class="text-center mb-8">
            <div class="bg-[#16782d]/10 inline-block p-4 rounded-full mb-4">
                <i class="fas fa-list text-2xl text-[#16782d]"></i>
            </div>
        ...
        <!-- Form Input -->
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="max-w-2xl mx-auto">
            @csrf
            <div class="space-y-5">
                <div>
            ...
            <div class="mt-8 flex justify-center">
                <button type="submit" class="bg-[#16782d] hover:bg-[#135e24] text-white font-semibold px-8 py-3 rounded-lg shadow-sm transition duration-200">
