...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-white to-green-50 p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <nav class="flex text-sm mb-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li class="flex items-center text-gray-500">
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="hover:text-[#16782d] transition-colors duration-200">Kelola Kategori</a>
                </li>
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('admin.categories.index') }}" class="text-sm font-medium text-white bg-[#16782d] px-4 py-2 rounded-lg hover:bg-[#135e24] transition flex items-center">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-gray-800 flex items-center">
                <i class="fas fa-table text-[#16782d] mr-2"></i> Master Kategori
            </h2>
            
            <a href="{{ route('admin.categories.create') }}" class="bg-[#16782d] hover:bg-[#135e24] text-white font-semibold py-2 px-4 rounded-lg transition flex items-center">
                                                    ...
                                                    <div>
                                                            ...
                                                            <div class="flex items-center mb-2">
                                                                ...
                                                                <div class="relative flex-1">
                                                                    ...
                                                                    <input type="file" name="foto_kategori" class="w-full border border-gray-300 rounded-md pl-10 pr-3 py-2 focus:ring-[#16782d] focus:border-[#16782d] text-sm">
                                                                </div>
                                                            </div>
