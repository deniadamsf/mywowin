...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-gradient-to-r from-white to-green-50 p-6 rounded-2xl shadow-lg border border-gray-200">
        ...
        <div class="flex gap-3 mt-4">
            ...
            <a href="{{ route('admin.bundlings.index') }}" class="text-sm font-medium text-[#16782d] border border-[#16782d] px-4 py-2 rounded-lg hover:bg-[#16782d]/10 transition flex items-center">
    ...
    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
        <div class="flex items-center justify-center mb-6">
            <div class="bg-[#16782d]/10 p-4 rounded-full">
                <i class="fas fa-percentage text-2xl text-[#16782d]"></i>
            </div>
        </div>
        ...
        <form action="{{ route('admin.bundlings.store') }}" method="POST" enctype="multipart/form-data" class="mx-auto max-w-4xl">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl">
                        <label for="Waktu_diskon_mulai" class="block text-gray-700 font-medium mb-2 flex items-center">
                            <i class="fas fa-calendar-plus text-[#16782d] mr-2"></i>
                            Waktu Diskon Mulai
                        </label>
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl">
                        <label for="Waktu_diskon_selesai" class="block text-gray-700 font-medium mb-2 flex items-center">
                            <i class="fas fa-calendar-minus text-[#16782d] mr-2"></i>
                            Waktu Diskon Selesai
                        </label>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-xl">
                        <label for="price_before" class="block text-gray-700 font-medium mb-2 flex items-center">
                            <i class="fas fa-money-bill text-[#16782d] mr-2"></i>
                            Harga Sebelum Diskon
                        </label>
                        <div class="relative">
                            <span class="absolute left-3 top-2.5 text-gray-500">Rp</span>
            ...
            <div class="mt-6 bg-gray-50 p-4 rounded-xl">
                <label for="snk" class="block text-gray-700 font-medium mb-2 flex items-center">
                    <i class="fas fa-file-contract text-[#16782d] mr-2"></i>
                    Syarat & Ketentuan
                </label>
                <div id="snk-editor">
