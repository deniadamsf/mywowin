...
class IlustrationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.ilustrations.index', compact('ilustrations')); 
    }
    ...
    {
        return view('admin.ilustrations.create');
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'gambar_login' => 'required|image|mimes:jpeg,png,jpg,gif,webp',
        ]);
        ...
        if ($request->hasFile('gambar_login')) {
         ...
         return redirect()->route('admin.ilustrations.index')->with('success', 'Gambar Ilustrations berhasil ditambahkan!');
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.ilustrations.index')->with('success', 'Data admin berhasil diperbarui!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.ilustrations.index')->with('success', 'Produk berhasil dihapus!');
    }
}
