...
class HeroController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.heros.index', compact('heros', 'search', 'dateFilter'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'gambar_hero' => 'required|image|mimes:jpeg,png,jpg,gif,webp',
        ]);
        ...
        if ($request->hasFile('gambar_hero')) {
         ...
         return redirect()->route('admin.heros.index')->with('success', 'Gambar hero berhasil ditambahkan!');
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.heros.index')->with('success', 'Data admin berhasil diperbarui!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.heros.index')->with('success', 'Produk berhasil dihapus!');
    }
}
